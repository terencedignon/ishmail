...
require 'faker'
  ...
  #     Email.create!(from_email: "heybud", draft_set: false, user_id: user.id, subject: "Welcome to Ishmail", body: "wakka wakka")
  #   end
...
from_email =  landlord.username
draft_set = false

landlord_email = Email.create!(from_name: from_email, recipient: recipient, subject: subject, body: body, user_id: user_id, from_email: from_email, draft_set: draft_set)

subject = "re: The harpooner"
body = "Landlord! What sort of a chap is he—does he always keep such late hours?"
user_id = landlord.id
from_email = ishmael.username
draft_set = false
parent_email_id = landlord_email.id

Email.create!(from_name: from_email, recipient: recipient, subject: subject, body: body, user_id: user_id, from_email: from_email, draft_set: draft_set, parent_email_id: parent_email_id)
...
from_email = ahab.username
draft_set = false

ahab_email = Email.create!(from_name: from_email, recipient: recipient, subject: subject, body: body, user_id: user_id, from_email: from_email, draft_set: draft_set, parent_email_id: parent_email_id)
...
from_email = stubb.username
user_id = ishmael.id
parent_email_id = nil

stubb_email = Email.create!(from_name: from_email, recipient: recipient, subject: subject, body: body, user_id: user_id, from_email: from_email, draft_set: draft_set, parent_email_id: parent_email_id)
...
parent_email_id = nil
user_id = ishmael.id
clam_or_cod = Email.create!(from_name: from_email, recipient: recipient, subject: subject, body: body, user_id: user_id, from_email: from_email, draft_set: draft_set, parent_email_id: parent_email_id)
...
user_id = ishmael.id
parent_email_id = nil
ahab_kickstarter = Email.create!(from_name: from_email, recipient: recipient, subject: subject, body: body, user_id: user_id, from_email: from_email, draft_set: draft_set, parent_email_id: parent_email_id)
...
# from_email = market_watch.username
# Email.create!(subject: subject, body: body, user_id: user_id, from_email: from_email, draft_set: draft_set, parent_email_id: parent_email_id)
#
...
#       rand_num = rand(1..100)
#       from_email = "#{first_name}@gmail.com"
...
#       Email.create!(from_email: from_email, user_id: user_id,
...
body = "Welcome! Your email address is ishmael@ishmail.co.  Ishmail is a web application inspired by Gmail, built using Ruby on Rails and React.js. Ishmail aims to provide Gmail's core functionality in a minimalist build.  You can send and receive emails, try it out!  Thanks for dropping by, and be in touch.  You can reach me here or at terry.p.dignon@gmail.com."
user_id = ishmael.id
from_name = "Terence Dignon"
from_email = terence.username
draft_set = false

Email.create!(subject: subject, body: body, user_id: user_id, from_name: from_name, from_email: from_email, draft_set: draft_set)
